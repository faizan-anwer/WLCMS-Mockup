		...
		<div class="portlet portlet-btn">
		  ...
		  <div class="portlet-body">
			<div role="alert" class="alert alert-warning">
				<i class="icon-warning-sign"></i><strong> Two</strong> and <strong>three</strong> categories, no more than 2 items can be dragged to any given category. Please make adjustments as needed. <br/>Each row represents the draggable object. Click the Add Row button <span class="btn btn-default" disabled="disabled"><i class="icon-plus"></i></span> to add more rows.
			</div>
			<div class="form-body">
			   <div class="form-group">
